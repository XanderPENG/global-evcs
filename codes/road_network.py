...
# cn_evcs = io_tool.load_processed_evcs_fusion_boundary(region='china',
#                                                       evcs_usecols=['name', 'province', 'city', 'wgs84_lng', 'wgs84_lat'],
#                                                       boundary_level='city',
#                                                       boundary_usecols= ['省级','地级', '地名'],
#                                                       # index_col=0
#                                                       )
# # Load road network
# china_road = network_tool.load_road('china')
# print("finish load china road")
...
#
#     current_buffer = gpd.read_file(EVCS_BUFFER_DIR + 'china//' + str(radius) + 'buffer.shp')
...
#
#     # Output the results
#     os.makedirs(OUTPUT_DIR + 'china//', exist_ok=True)
#     region_cs.to_csv(OUTPUT_DIR + 'china//' + str(radius) + '_roads.csv.gz')
